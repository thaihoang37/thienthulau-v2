...
Output: Bạn PHẢI trả về một JSON object với 2 trường:
- "translations": JSON array chứa danh sách các ĐOẠN văn tiếng Việt tương ứng, giữ nguyên thứ tự và số lượng đoạn.
- "summary": Một đoạn tóm tắt ngắn gọn (2-4 câu) bằng tiếng Việt, miêu tả các sự kiện chính xảy ra trong chương này.
...
Yêu cầu cho summary:
- Tóm tắt ngắn gọn các sự kiện chính, nhân vật quan trọng xuất hiện, và diễn biến chính của chương.
...
Output: {"translations": ["Trương Tam bước vào phòng. Hắn nhìn thấy một chiếc rương báu.", "Trong rương có một viên Kim Đan. Hắn cẩn thận cầm lấy.", "Viên Kim Đan này toả ra linh khí nồng nàn."], "summary": "Trương Tam phát hiện một chiếc rương báu trong phòng, bên trong chứa một viên Kim Đan tỏa linh khí nồng nàn. Hắn cẩn thận cầm lấy viên đan dược quý giá."}
